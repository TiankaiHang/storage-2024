...
def main():
    ...
    sd = load_safetensors(
        "LOGS/stabilityai/stable-video-diffusion-img2vid-xt-1-1/svd_xt_1_1.safetensors"
    )

    pipe = StableVideoDiffusionPipeline.from_pretrained(
        "LOGS/stabilityai/stable-video-diffusion-img2vid-xt", 
    ...
    new_unet = convert_ldm_unet_checkpoint(
        checkpoint=sd,
        config=unet_config,
    )
